...
const regulationVersions: Record<RegulationVersionName, RegulationVersion> = {
  latest: {
    ...
    affinityOptions,
    fetch: () => fetch(`/regulation-vanilla-v1.13.js?${import.meta.env.VITE_DATA_FORMAT}`),
  },
  reforged: {
    ...
    fetch: () => fetch(`/regulation-reforged-v0.13.5A.js?${import.meta.env.VITE_DATA_FORMAT}`),
  },
  convergence: {
    ...
    fetch: () => fetch(`/regulation-convergence-v2.0.3b.js?${import.meta.env.VITE_DATA_FORMAT}`),
  },
};
