...
const regulationVersions: Record<RegulationVersionName, RegulationVersion> = {
  ...
  reforged: {
    ...
    fetch: () => fetch(`/regulation-reforged-v0.11.97B.js?${import.meta.env.VITE_DATA_FORMAT}`),
  },
  convergence: {
    ...
    fetch: () => fetch(`/regulation-convergence-v1.4.1.2.js?${import.meta.env.VITE_DATA_FORMAT}`),
  },
};
