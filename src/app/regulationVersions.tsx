...
const regulationVersions: Record<RegulationVersionName, RegulationVersion> = {
  ...
  reforged: {
    ...
    fetch: () => fetch(`/regulation-reforged-v0.10.1D.js?${import.meta.env.VITE_DATA_FORMAT}`),
  },
  convergence: {
    ...
    fetch: () => fetch(`/regulation-convergence-v1.3.3.js?${import.meta.env.VITE_DATA_FORMAT}`),
  },
};
